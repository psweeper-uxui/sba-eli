...
CREATE VIEW public.assignment_student_visibilities AS
 SELECT DISTINCT a.id AS assignment_id,
   ...
   FROM (public.assignments a
     JOIN public.enrollments e ON (((e.course_id = a.context_id) AND ((a.context_type)::text = 'Course'::text) AND ((e.type)::text = ANY (ARRAY[('StudentEnrollment'::character varying)::text, ('StudentViewEnrollment'::character varying)::text])) AND ((e.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('rejected'::character varying)::text, ('inactive'::character varying)::text])))))
  WHERE (((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (COALESCE(a.only_visible_to_overrides, false) = false))
UNION
 SELECT DISTINCT a.id AS assignment_id,
    e.user_id,
    e.course_id
  ...
  WHERE (((ao.workflow_state)::text = 'active'::text) AND ((aos.workflow_state)::text <> 'deleted'::text) AND ((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (a.only_visible_to_overrides = true))
UNION
 SELECT DISTINCT a.id AS assignment_id,
    e.user_id,
    e.course_id
  ...
  WHERE (((gm.workflow_state)::text <> 'deleted'::text) AND ((g.workflow_state)::text <> 'deleted'::text) AND ((ao.workflow_state)::text = 'active'::text) AND ((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (a.only_visible_to_overrides = true))
UNION
 SELECT DISTINCT a.id AS assignment_id,
    e.user_id,
    e.course_id
  ...
  WHERE (((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (a.only_visible_to_overrides = true) AND ((ao.workflow_state)::text = 'active'::text))
UNION
 SELECT DISTINCT a.id AS assignment_id,
    e.user_id,
    e.course_id
   FROM ((public.assignments a
     JOIN public.enrollments e ON (((e.course_id = a.context_id) AND ((a.context_type)::text = 'Course'::text) AND ((e.type)::text = ANY (ARRAY[('StudentEnrollment'::character varying)::text, ('StudentViewEnrollment'::character varying)::text])) AND ((e.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('rejected'::character varying)::text, ('inactive'::character varying)::text])))))
     JOIN public.submissions s ON (((s.user_id = e.user_id) AND (s.assignment_id = a.id) AND ((s.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unsubmitted'::character varying)::text])))))
  WHERE (((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (a.only_visible_to_overrides = true));
...
CREATE VIEW public.quiz_student_visibilities AS
 SELECT DISTINCT q.id AS quiz_id,
  ...
  WHERE (((q.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (COALESCE(q.only_visible_to_overrides, false) = false))
UNION
 SELECT DISTINCT q.id AS quiz_id,
    e.user_id,
    e.course_id
   FROM (((public.quizzes q
     ...
     JOIN public.assignment_override_students aos ON (((ao.id = aos.assignment_override_id) AND (aos.user_id = e.user_id))))
  WHERE (((ao.workflow_state)::text = 'active'::text) AND ((aos.workflow_state)::text <> 'deleted'::text) AND ((q.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (q.only_visible_to_overrides = true))
UNION
 SELECT DISTINCT q.id AS quiz_id,
    e.user_id,
    e.course_id
  ...
  WHERE (((q.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (q.only_visible_to_overrides = true) AND ((ao.workflow_state)::text = 'active'::text))
UNION
 SELECT DISTINCT q.id AS quiz_id,
    e.user_id,
    e.course_id
  ...
  WHERE (((a.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND ((q.workflow_state)::text <> ALL (ARRAY[('deleted'::character varying)::text, ('unpublished'::character varying)::text])) AND (q.only_visible_to_overrides = true));
...
--
-- Name: quiz_submission_events_2018_10; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.quiz_submission_events_2018_10 (
    ...
    event_data text,
    created_at timestamp without time zone,
    CONSTRAINT quiz_submission_events_2018_10_created_at_check CHECK (((created_at >= '2018-10-01 00:00:00'::timestamp without time zone) AND (created_at < '2018-11-01 00:00:00'::timestamp without time zone)))
)
INHERITS (public.quiz_submission_events);


--
-- Name: quiz_submission_events_2018_11; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.quiz_submission_events_2018_11 (
    id bigint DEFAULT nextval('public.quiz_submission_events_id_seq'::regclass),
    attempt integer,
    event_type character varying(255),
    quiz_submission_id bigint,
    event_data text,
    created_at timestamp without time zone,
    CONSTRAINT quiz_submission_events_2018_11_created_at_check CHECK (((created_at >= '2018-11-01 00:00:00'::timestamp without time zone) AND (created_at < '2018-12-01 00:00:00'::timestamp without time zone)))
)
INHERITS (public.quiz_submission_events);
...
CREATE TABLE public.quiz_submission_events_2018_12 (
    id bigint DEFAULT nextval('public.quiz_submission_events_id_seq'::regclass),
    attempt integer,
    event_type character varying(255),
    quiz_submission_id bigint,
...
--
-- Name: quiz_submission_events_2018_10 quiz_submission_events_2018_10_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quiz_submission_events_2018_10
    ADD CONSTRAINT quiz_submission_events_2018_10_pkey PRIMARY KEY (id);


--
-- Name: quiz_submission_events_2018_11 quiz_submission_events_2018_11_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quiz_submission_events_2018_11
    ADD CONSTRAINT quiz_submission_events_2018_11_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.quiz_submission_events_2018_12
...
--
-- Name: index_group_categories_on_root_account_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_lti_resource_links_on_resource_link_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_outcome_proficiencies_on_account_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_submissions_on_user_id_and_context_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: quiz_submission_events_2018_10_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quiz_submission_events_2018_10_created_at_idx ON public.quiz_submission_events_2018_10 USING btree (created_at);


--
-- Name: quiz_submission_events_2018_11_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quiz_submission_events_2018_11_created_at_idx ON public.quiz_submission_events_2018_11 USING btree (created_at);
...
--
-- Name: quiz_submission_events_2018_1_quiz_submission_id_attempt_c_idx1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quiz_submission_events_2018_1_quiz_submission_id_attempt_c_idx1 ON public.quiz_submission_events_2018_11 USING btree (quiz_submission_id, attempt, created_at);


--
-- Name: quiz_submission_events_2018_1_quiz_submission_id_attempt_c_idx2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX quiz_submission_events_2018_1_quiz_submission_id_attempt_c_idx2 ON public.quiz_submission_events_2018_12 USING btree (quiz_submission_id, attempt, created_at);
...
CREATE INDEX quiz_submission_events_2018_1_quiz_submission_id_attempt_cr_idx ON public.quiz_submission_events_2018_10 USING btree (quiz_submission_id, attempt, created_at);
...
--
-- Name: versions_0_versionable_id_versionable_type_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: versions_1_versionable_id_versionable_type_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: outcome_proficiencies fk_rails_49adcf658c; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quiz_submission_events_2018_11 fk_rails_4cf40d5227; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quiz_submission_events_2018_11
    ADD CONSTRAINT fk_rails_4cf40d5227 FOREIGN KEY (quiz_submission_id) REFERENCES public.quiz_submissions(id);
...
ALTER TABLE ONLY public.quiz_submission_events_2018_12
    ADD CONSTRAINT fk_rails_64a1536925 FOREIGN KEY (quiz_submission_id) REFERENCES public.quiz_submissions(id);
...
--
-- Name: quiz_submission_events_2018_10 fk_rails_828893beda; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quiz_submission_events_2018_10
    ADD CONSTRAINT fk_rails_828893beda FOREIGN KEY (quiz_submission_id) REFERENCES public.quiz_submissions(id);
...
ALTER TABLE ONLY public.content_migrations
    ADD CONSTRAINT fk_rails_9bdc9d1482 FOREIGN KEY (attachment_id) REFERENCES public.attachments(id);
...
ALTER TABLE ONLY public.content_exports
    ADD CONSTRAINT fk_rails_be83a37440 FOREIGN KEY (content_migration_id) REFERENCES public.content_migrations(id);
...
ALTER TABLE ONLY public.content_migrations
    ADD CONSTRAINT fk_rails_c345a5b6d1 FOREIGN KEY (source_course_id) REFERENCES public.courses(id);
...
ALTER TABLE ONLY public.folders
    ADD CONSTRAINT fk_rails_da2ad09897 FOREIGN KEY (cloned_item_id) REFERENCES public.cloned_items(id);
