...
class SessionController < ApplicationController
  ...
  # /session/refresh will refresh the token saved in application.yml
  # requires CANVAS_TOKEN and CANVAS_REFRESH_TOKEN saved
  ...
  def refresh_token
    ...
    @response = HTTParty.post("#{APP_CONFIG['canvas_host']}/login/oauth2/token", params)
